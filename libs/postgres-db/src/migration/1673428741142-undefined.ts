...
export class undefined1673428741142 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "client_project" ADD CONSTRAINT "FK_95e416127c2498a90a1a4597e9e" FOREIGN KEY ("soloClientId") REFERENCES "solo_client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "client_project" DROP CONSTRAINT "FK_95e416127c2498a90a1a4597e9e"`,
    )
