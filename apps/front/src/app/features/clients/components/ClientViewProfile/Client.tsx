    ...
    >
      <Box display={'flex'} flexDirection={'column'} gap={'15px'}>
        <Grid container={true}>
          ...
          <Grid item={true} xs={8}>
            <AtTypography color={grey}>{props.client.email}</AtTypography>
          </Grid>
        </Grid>
        ...
        <Grid container={true}>
          ...
          <Grid item={true} xs={8}>
            <AtTypography color={grey}>Andrew Gigs</AtTypography>
          </Grid>
        </Grid>
        ...
        <Grid container={true}>
          ...
          <Grid item={true} xs={8}>
            <AtTypography color={grey}>Co-founder</AtTypography>
          </Grid>
        </Grid>
      </Box>
